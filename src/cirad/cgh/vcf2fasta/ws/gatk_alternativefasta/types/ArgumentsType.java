/*
 *
 * CGH_VCF2Fasta cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ArgumentsType
 *
...
public class ArgumentsType  implements java.io.Serializable {
    private cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.FlagsType[] flags;

    private cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ParamsArrayType taggedParams;

    private cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ParamsArrayType untaggedParams;

    private cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ImplicitParamsType[] implicitParams;

    private cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.GroupsType[] groups;

    public ArgumentsType() {
    }

    public ArgumentsType(
           cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.FlagsType[] flags,
           cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ParamsArrayType taggedParams,
           cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ParamsArrayType untaggedParams,
           cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ImplicitParamsType[] implicitParams,
           cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.GroupsType[] groups) {
           this.flags = flags;
     ...
     * @return flags
     */
    public cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.FlagsType[] getFlags() {
        return flags;
    }
     ...
     * @param flags
     */
    public void setFlags(cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.FlagsType[] flags) {
        this.flags = flags;
    }
     ...
     * @return taggedParams
     */
    public cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ParamsArrayType getTaggedParams() {
        return taggedParams;
    }
     ...
     * @param taggedParams
     */
    public void setTaggedParams(cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ParamsArrayType taggedParams) {
        this.taggedParams = taggedParams;
    }
     ...
     */
    public cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ParamsArrayType getUntaggedParams() {
        return untaggedParams;
    }
     ...
     */
    public void setUntaggedParams(cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ParamsArrayType untaggedParams) {
        this.untaggedParams = untaggedParams;
    }
     ...
     */
    public cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ImplicitParamsType[] getImplicitParams() {
        return implicitParams;
    }
     ...
     */
    public void setImplicitParams(cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ImplicitParamsType[] implicitParams) {
        this.implicitParams = implicitParams;
    }
     ...
     * @return groups
     */
    public cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.GroupsType[] getGroups() {
        return groups;
    }
     ...
     * @param groups
     */
    public void setGroups(cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.GroupsType[] groups) {
        this.groups = groups;
    }
