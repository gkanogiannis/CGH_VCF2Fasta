/*
 *
 * CGH_VCF2Fasta cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ParamsType
 *
...
public class ParamsType  implements java.io.Serializable {
    ...
    private cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ParamType paramType;

    private cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.IOType ioType;
    ...
    public ParamsType(
           ...
           cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ParamType paramType,
           cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.IOType ioType,
     ...
     * @return paramType
     */
    public cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ParamType getParamType() {
        return paramType;
    }
     ...
     * @param paramType
     */
    public void setParamType(cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ParamType paramType) {
        this.paramType = paramType;
    }
     ...
     * @return ioType
     */
    public cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.IOType getIoType() {
        return ioType;
    }
     ...
     * @param ioType
     */
    public void setIoType(cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.IOType ioType) {
        this.ioType = ioType;
    }
