/*
 *
 * CGH_VCF2Fasta cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.JobInputType
 *
...
public class JobInputType  implements java.io.Serializable {
    ...
    private cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.InputFileType[] inputFile;
    ...
    public JobInputType(
           ...
           cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.InputFileType[] inputFile,
     ...
     * @return inputFile
     */
    public cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.InputFileType[] getInputFile() {
        return inputFile;
    }
     ...
     * @param inputFile
     */
    public void setInputFile(cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.InputFileType[] inputFile) {
        this.inputFile = inputFile;
    }

    public cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.InputFileType getInputFile(int i) {
        return this.inputFile[i];
    }

    public void setInputFile(int i, cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.InputFileType _value) {
