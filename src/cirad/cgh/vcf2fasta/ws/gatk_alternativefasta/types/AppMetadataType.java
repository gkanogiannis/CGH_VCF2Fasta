/*
 *
 * CGH_VCF2Fasta cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.AppMetadataType
 *
...
public class AppMetadataType  implements java.io.Serializable {
    ...
    private cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ArgumentsType types;
    ...
    public AppMetadataType(
           ...
           cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ArgumentsType types,
     ...
     * @return types
     */
    public cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ArgumentsType getTypes() {
        return types;
    }
     ...
     * @param types
     */
    public void setTypes(cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.ArgumentsType types) {
        this.types = types;
    }
