/*
 *
 * CGH_VCF2Fasta cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.AppConfigType
 *
...
public class AppConfigType  implements java.io.Serializable {
    private cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.AppMetadataType metadata;
    ...
    public AppConfigType(
           cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.AppMetadataType metadata,
     ...
     * @return metadata
     */
    public cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.AppMetadataType getMetadata() {
        return metadata;
    }
     ...
     * @param metadata
     */
    public void setMetadata(cirad.cgh.vcf2fasta.ws.gatk_alternativefasta.types.AppMetadataType metadata) {
        this.metadata = metadata;
    }
